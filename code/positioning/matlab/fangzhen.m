...
if ~exist('data/trajectory', 'dir')
    mkdir('data/trajectory');
end
writetable(data_table, 'data/trajectory/PipeRobot_Trajectory.csv');
fprintf('✅ 轨迹已保存：data/trajectory/PipeRobot_Trajectory.csv\n');
