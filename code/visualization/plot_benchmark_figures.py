...
fig.tight_layout()
fig.savefig(FIGURE_DIR / 'trajectory_runtime_comparison.png', bbox_inches='tight')
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIGURE_DIR / 'workflow_runtime_breakdown.png', bbox_inches='tight')
plt.close(fig)

print(f'Saved: {FIGURE_DIR / "trajectory_runtime_comparison.png"}')
print(f'Saved: {FIGURE_DIR / "workflow_runtime_breakdown.png"}')
