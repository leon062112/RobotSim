...
def run_ekf_v6_mixed(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None,
...
def sweep_v6(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None, quick=False):
    ...
    out_path = os.path.join(repo_root, 'data', 'results', 'v6_mixed_precision.json')
