...
def run_one(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None, combo='fp32-ieee', verbose=True):
...
def sweep():
    ...
    with open('data/results/v6_layer_precision.json','w') as f: json.dump(results,f,indent=2,ensure_ascii=False)
    print("\nSaved → data/results/v6_layer_precision.json")
    return results
