...
# Ensure code/optimization is on path to import the v5 kernel.
...
def run_ekf_v7_events(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None,
...
def diagnose_b8(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None, n_trials=5):
...
def sweep_b_concurrency(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None,
...
def sweep_stream_overlap(csv_path='data/trajectory/PipeRobot_Trajectory.csv', n_steps=None,
                          precision='fp32', quick=False):
    """
...
def main(quick=False):
    ...
    os.makedirs(os.path.join(repo_root, 'data', 'results'), exist_ok=True)
    out_path = os.path.join(repo_root, 'data', 'results', 'v7_concurrency.json')
