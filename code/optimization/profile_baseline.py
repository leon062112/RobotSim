...
用法: python code/optimization/profile_baseline.py --device cpu --n 2000
"""
import os
import argparse
import torch
...
def main():
    ...
    ap.add_argument('--csv', default='data/trajectory/PipeRobot_Trajectory.csv')
    ...
    trace_path = f'data/profiles/{tag}_trace.json'
    prof.export_chrome_trace(trace_path)

    txt_path = f'data/profiles/{tag}_summary.txt'
