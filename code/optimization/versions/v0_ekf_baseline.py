"""
EKF 基线（源自 code/positioning/ekf.py），参数化以便基准测试：
- device: 'cpu' / 'cuda'
...
def run_ekf_baseline(csv_path='data/trajectory/PipeRobot_Trajectory.csv', device='cpu', n_steps=None, verbose=True):
