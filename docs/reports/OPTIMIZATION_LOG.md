...
数据集: `data/trajectory/PipeRobot_Trajectory.csv`, N=166667 步, float64
...
代码: code/optimization/ekf_baseline.py
...
data/profiles/v0_cpu_n2000_summary.txt + _trace.json
...
代码: code/optimization/ekf_v1.py
...
代码: code/optimization/ekf_v2.py
...
代码: code/optimization/analyze_data_pattern.py → data/results/data_pattern_analysis.json
...
代码: code/optimization/ekf_v3.py (kernel building blocks 验证: triton_blocks.py / triton_features.py / triton_probe.py)
...
代码: code/optimization/benchmark.py → data/results/benchmark_summary.json
...
## TODO #5 Baseline 与对比实验调研 (报告: docs/reports/RESEARCH_TODO5_baseline.md)
...
代码: code/optimization/ekf_v4.py (DT/IP 做成 constexpr 模板, 一份 kernel 跑三档精度), 结果: data/results/v4_precision_full.json
...
代码: code/optimization/ekf_v5.py (grid=(B,), 每 block 一条独立 scan), 结果: data/results/v5_batch_scaling.json
...
### SM Profiling (ncu/nsys, data/results/sm_profiling.json)
...
## 小矩阵特性分析 (Background 素材, data/results/small_matrix_characterization.json)
...
最终报告: docs/reports/FINAL_REPORT_v2.md
