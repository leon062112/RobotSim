...
> 数据集: `data/trajectory/PipeRobot_Trajectory.csv` (N=166667 步, 100Hz, float64)
...
见 `data/profiles/v0_cpu_n2000_summary.txt`。
...
见 `data/results/data_pattern_analysis.json`。
...
见 `data/results/benchmark_summary.json` (统一 RMSE 校验 + 吞吐)。完整表格见第 0 节。
